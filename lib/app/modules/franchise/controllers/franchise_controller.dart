...
import '../../../data/services/franchise/franchise_service.dart';

class FranchiseController extends GetxController {
  //TODO: Implement FranchiseController
  ...
  final hotelNameController = TextEditingController().obs;

  final hotelCityController = TextEditingController().obs;
  ...
  final FranchiseService franchiseService = chopperClient.getService<FranchiseService>();
    ...
    try {
      ...
      if(globalKey.value.currentState!.validate()){
        ...
        final request = {
          ...
          "property_name":hotelNameController.value.text,
          "property_city":hotelCityController.value.text
        };


        final response = await franchiseService.submitFranchise(request);
        ...
        if (response.isSuccessful) {
          ...
          CommonDialogs.CommonStatusDialog(
            ...
            title: AppStrings.applicationReceived,
            message: AppStrings.thankYouForYourInterestInSoonstays,
  ...
  clearData(){
    ...
    hotelNameController.value.clear();

    hotelCityController.value.clear();
